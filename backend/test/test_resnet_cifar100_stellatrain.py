...
# ✅ W&B 온라인 모드 설정
wandb.init(project="resnet-cifar100-stellatrain", name="resnet18-topk-sgd-gpu")
...
train_loader = DataLoader(train_dataset, batch_size=512, shuffle=True, num_workers=4)  # ✅ 512로 증가
